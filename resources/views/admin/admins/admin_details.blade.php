...
@endif
              ...
              <form role="form" method="post" action="{{ url('/admin/admin-details') }}" name="updateAdminDetails" id="updateAdminDetails" enctype="multipart/form-data">@csrf
                <div class="card-body">
...
@endif
                    ...
                    <input type="file" class="form-control" id="admin_image" name="admin_image" placeholder="Фото" >
                  </div>
