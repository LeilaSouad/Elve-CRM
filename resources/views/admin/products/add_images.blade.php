    ...
    <section class="content">
      <div class="container-fluid">
          ...
          <div class="card card-default">
            ...
            <div class="card-body">
              <div class="row">
                ...
                <div class="col-md-6"> 
                  <div class="form-group">
                      <img style="width:120px;" src="{{ asset('images/product_images/small/'.$productdata['product_main_image']) }}">
                  </div>
                </div>
                <div class="col-md-6"> 
                  <div class="form-group">
                      <div class="field_wrapper">
                        <div>
                            <input multiple="" id="images" name="images[]" type="file" name="images[]" value="" placeholder="Фото" style="width: 120px;" required="" />
        ...
        <form name="editImagesForm" id="editImagesForm" method="post" action="{{ url('admin/edit-images/'.$productdata['id']) }}">@csrf
          <div class="card">
              <div class="card-header">
                <h3 class="card-title">Added Фото</h3>
              </div>
              <!-- /.card-header -->
              <div class="card-body">
